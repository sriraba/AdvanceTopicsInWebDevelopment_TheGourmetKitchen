...
const Signup = () => {
    const backGroundStyle = { padding: 20, height: 'auto', width: 280, margin: "5% auto" }
        ...
        <form onSubmit={onSubmit}>
            <Grid>
                <Paper elevation={8} style={backGroundStyle}>
                    <Typography variant="overline" display="block" gutterBottom>Sign yourself up!</Typography>
                    ...
                    <Button type='submit' color='primary' variant="contained" style={buttonstyle} fullWidth>Register</Button>
                    <InputLabel >Already have an account?
